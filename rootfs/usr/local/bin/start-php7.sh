...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211141955-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  start-php7.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Monday, Nov 14, 2022 19:55 EST
# @@File             :  start-php7.sh
# @@Description      :  script to start php7
...
HOSTNAME="${HOSTNAME:-casjaysdev-php7}"
...
*)
  if __pgrep "$SERVICE_NAME" && [ ! -f "/tmp/$SERVICE_NAME.pid" ]; then
    ...
    echo "$start_message"
    __exec_command $SERVICE_NAME --allow-to-run-as-root --nodaemonize --fpm-config /etc/php/php-fpm.conf || rm -Rf "/tmp/$SERVICE_NAME.pid"
  fi
  ;;
esac
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
