...
```shell
dockermgr download src php7
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/php7" "$HOME/Projects/github/casjaysdevdocker/php7"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/php7"
buildx 
```
